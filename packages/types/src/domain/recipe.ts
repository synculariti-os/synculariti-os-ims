...
export interface Recipe { id: RecipeId; franchiseGroupId: FranchiseGroupId | null; restaurantId: RestaurantId | null; producesItemId: ItemId; yieldQuantity: number; createdAt: string; updatedAt: string; }
...
export interface MenuItemMapping { id: MenuItemMappingId; restaurantId: RestaurantId; rawExcelString: string; recipeId: RecipeId; createdAt: string; }
