const fs = require('fs');
const file = 'apps/web/src/components/items/create-item-dialog.tsx';
let code = fs.readFileSync(file, 'utf8');

// Update defaults
const defaultsSearch = `categoryId: '',
    },`;
const defaultsReplace = `categoryId: '',
      allergens: [],
      caloriesPerUom: 0,
      proteinGrams: 0,
      fatGrams: 0,
...
// Update payload
const payloadSearch = `categoryId: data.categoryId,
        },`;
const payloadReplace = `categoryId: data.categoryId,
