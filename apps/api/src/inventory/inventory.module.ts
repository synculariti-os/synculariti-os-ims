...
@Module({
  ...
  exports: [INVENTORY_TRANSFER_SERVICE_TOKEN, LEDGER_SERVICE_TOKEN, INVENTORY_COUNT_SERVICE_TOKEN, WASTE_SERVICE_TOKEN, PREP_SERVICE_TOKEN, STOCK_QUERY_SERVICE_TOKEN],
})
